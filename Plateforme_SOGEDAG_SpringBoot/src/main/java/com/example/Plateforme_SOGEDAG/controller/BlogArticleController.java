...
public class BlogArticleController {
    ...
    public ResponseEntity<BlogArticleDTO> create(
            ...
            @RequestParam(value = "datePublication", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime datePublication,
    ...
    public ResponseEntity<BlogArticleDTO> update(
        ...
        return ResponseEntity.ok(blogArticleService.update(id, dto, image));
    }
